...
export const sourceMetadata: SourceMetadata[] = [
  { source_name: "DWP Stat-Xplore", category: "Income", public_availability: true, update_frequency: "Monthly", description: "Universal Credit and benefit claimant data from DWP", status: "active", coverage: "England & Wales", link: "#" },
  { source_name: "ONS Nomis", category: "Employment", public_availability: true, update_frequency: "Monthly", description: "Labour market statistics including claimant count and economic activity", status: "active", coverage: "UK-wide", link: "#" },
  { source_name: "DfE Statistics", category: "Education", public_availability: true, update_frequency: "Annual", description: "School performance, absence rates, and attainment data", status: "active", coverage: "England", link: "#" },
  { source_name: "NHS Digital", category: "Health", public_availability: true, update_frequency: "Quarterly", description: "Hospital admissions, GP registrations, and health outcomes", status: "active", coverage: "England", link: "#" },
  { source_name: "Census 2021 Microdata", category: "Housing", public_availability: true, update_frequency: "Decennial", description: "Overcrowding, tenure, and household composition data", status: "active", coverage: "England & Wales", link: "#" },
  { source_name: "Ofcom Connected Nations", category: "Access to Services", public_availability: true, update_frequency: "Annual", description: "Broadband coverage and speed data by area", status: "active", coverage: "UK-wide", link: "#" },
  { source_name: "Police.uk Open Data", category: "Crime", public_availability: true, update_frequency: "Monthly", description: "Street-level crime and anti-social behaviour data", status: "active", coverage: "England & Wales", link: "#" },
  { source_name: "DEFRA Open Data", category: "Environment", public_availability: true, update_frequency: "Annual", description: "Air quality, flood risk, and green space indicators", status: "active", coverage: "England", link: "#" },
  { source_name: "BEIS Energy Statistics", category: "Housing", public_availability: true, update_frequency: "Annual", description: "Fuel poverty estimates and energy performance data", status: "pending", coverage: "England & Wales", link: "#" },
  { source_name: "OS Open Geography", category: "Geography", public_availability: true, update_frequency: "Quarterly", description: "Boundary data and geographic lookups for LSOA/MSOA/LA", status: "active", coverage: "UK-wide", link: "#" },
];
